...
/**
 * 
 * Title: NettyClient Description: Netty客户端 Version:1.0.0
 * 
...
public class NettyClient {
	...
	public static String host = "47.105.170.21"; // ip地址
	public static int port = 9998; // 端口
	public static int hdscontrol = 0; // 端口
	 ...
	 * IOException { System.out.println("客户端成功启动..."); b.group(group);
	 * b.channel(NioSocketChannel.class); b.handler(new NettyClientFilter()); //
	 * 连接服务端 ch = b.connect(host, port).sync().channel(); //star(); }
	 **/
	...
	public static void SendLoginData(String projectName) throws Exception {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy.MM.dd HH:mm:ss");
		JSONObject jObject = new JSONObject();
		jObject.put("command", "login");
		jObject.put("projectName", projectName);
		jObject.put("sendTime", sdf.format(new Date()));
		ch.writeAndFlush(jObject.toJSONString());
	}
