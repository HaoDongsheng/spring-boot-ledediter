...
import org.hds.model.*;
import org.hds.mapper.*;
import org.hds.GJ_coding.*;
...
public class AdvMangerServiceImpl implements IAdvMangerService{
	...
	{							
		...
		if(isSuperuser==0){
			...
			{
				int grpid =Integer.parseInt(grpStrings[i].substring(grpStrings[i].indexOf('#') + 1, grpStrings[i].lastIndexOf('#')));
