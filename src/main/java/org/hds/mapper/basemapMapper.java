...
public interface basemapMapper {
    ...
    @Insert({
        "insert into t_basemap (Id, basemapname, projectid,imgtype,",
        "basemapclassify, basemaptype, ",
    ...
    @Select({
        ...
        "from t_basemap",
        "where Id = #{id,jdbcType=INTEGER} and delindex = 0"
    })
    @Results({
    ...
    @Update({
        "update t_basemap",
        "set basemapname = #{basemapname,jdbcType=VARCHAR},",
          "projectid = #{projectid,jdbcType=VARCHAR},",
          "imgtype = #{imgtype,jdbcType=INTEGER},",
          "basemapclassify = #{basemapclassify,jdbcType=VARCHAR},",
          "basemaptype = #{basemaptype,jdbcType=VARCHAR},",
          "basemapstyle = #{basemapstyle,jdbcType=VARCHAR},",
          "basemapdata = #{basemapdata,jdbcType=LONGVARCHAR}",
