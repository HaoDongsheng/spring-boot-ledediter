...
public interface itemMapper {
	@Delete({ "delete from t_item", "where infoSN = #{infoSN,jdbcType=VARCHAR}",
			"and pageid = #{pageid,jdbcType=INTEGER}", "and itemid = #{itemid,jdbcType=INTEGER}" })
	int deleteByPrimaryKey(@Param("infoSN") String infoSN, @Param("pageid") Integer pageid,
			@Param("itemid") Integer itemid);

	@Delete({ "delete from t_item", "where infoSN = #{infoSN,jdbcType=VARCHAR}" })
	int deleteByadid(@Param("infoSN") String infoSN);

	@Insert({ "insert into t_item (infoSN, pageid, ", "itemid, itemleft, ", "itemtop, itemwidth, ",
			...
			"values (#{infoSN,jdbcType=VARCHAR}, #{pageid,jdbcType=INTEGER}, ",
	...
	@Select({ "select",
			...
			"itemtype, delindex, itemContext, itemContextJson, itemStyle", "from t_item",
			"where infoSN = #{infoSN,jdbcType=VARCHAR}", "and pageid = #{pageid,jdbcType=INTEGER}",
	...
	item selectByPrimaryKey(@Param("infoSN") String infoSN, @Param("pageid") Integer pageid,
			@Param("itemid") Integer itemid);
	...
	@Results({ @Result(column = "infoSN", property = "infoSN", jdbcType = JdbcType.VARCHAR, id = true),
			...
			@Result(column = "itemContextJson", property = "itemcontextjson", jdbcType = JdbcType.LONGVARCHAR),
			@Result(column = "itemStyle", property = "itemstyle", jdbcType = JdbcType.LONGVARCHAR) })
	List<item> selectByadid(@Param("infoSN") String infoSN);

	@UpdateProvider(type = itemSqlProvider.class, method = "updateByPrimaryKeySelective")
	int updateByPrimaryKeySelective(item record);

	@Update({ "update t_item", "set itemleft = #{itemleft,jdbcType=INTEGER},", "itemtop = #{itemtop,jdbcType=INTEGER},",
			"itemwidth = #{itemwidth,jdbcType=INTEGER},", "itemheight = #{itemheight,jdbcType=INTEGER},",
			"itemfontno = #{itemfontno,jdbcType=INTEGER},", "itembackcolor = #{itembackcolor,jdbcType=VARCHAR},",
			"itembackopacity = #{itembackopacity,jdbcType=INTEGER},",
			"itemforecolor = #{itemforecolor,jdbcType=VARCHAR},",
			"itemforeopacity = #{itemforeopacity,jdbcType=INTEGER},", "itemtype = #{itemtype,jdbcType=INTEGER},",
			"delindex = #{delindex,jdbcType=INTEGER},", "itemContext = #{itemcontext,jdbcType=LONGVARCHAR},",
			"itemContextJson = #{itemcontextjson,jdbcType=LONGVARCHAR},",
			"itemStyle = #{itemstyle,jdbcType=LONGVARCHAR}", "where infoSN = #{infoSN,jdbcType=VARCHAR}",
			"and pageid = #{pageid,jdbcType=INTEGER}", "and itemid = #{itemid,jdbcType=INTEGER}" })
	...
	@Update({ "update t_item", "set itemleft = #{itemleft,jdbcType=INTEGER},", "itemtop = #{itemtop,jdbcType=INTEGER},",
			...
			"itemforecolor = #{itemforecolor,jdbcType=VARCHAR},",
			"itemforeopacity = #{itemforeopacity,jdbcType=INTEGER},", "itemtype = #{itemtype,jdbcType=INTEGER},",
			"delindex = #{delindex,jdbcType=INTEGER}", "where infoSN = #{infoSN,jdbcType=VARCHAR}",
			"and pageid = #{pageid,jdbcType=INTEGER}", "and itemid = #{itemid,jdbcType=INTEGER}" })
	int updateByPrimaryKey(item record);

	@Update({ "update t_item", "set delindex = #{1}", "where infoSN = #{0}" })
	int updateDelindexByPrimaryinfoSN(String infoSN, int delindex);
}