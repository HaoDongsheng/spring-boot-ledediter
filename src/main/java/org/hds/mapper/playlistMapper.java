...
public interface playlistMapper {
    ...
    @Insert({
        "insert into t_playlist (playlistSN, groupid, pubid,",
        "playlistname, playlistlevel, ",
        "playlistLifeAct, playlistLifeDie, creater, createDate,",
        "ScheduleType, DelIndex, ",
    ...
    @Select({
        ...
        "ScheduleType, DelIndex, Timequantum, programlist, mutiProgramlist",
        "from t_playlist",
        "where playlistSN = #{playlistSN,jdbcType=INTEGER}"
    })
    @Results({
